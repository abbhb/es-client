...
export const signMethods = ['HEAD', 'GET', 'POST', 'PUT', 'DELETE'];
...
export const signs = ['/', '/_cluster/settings', '/_cat/allocation?v', '/_cat/shards?v', '/_cat/shards/', '/_cat/master?v',
    ...
    '/_cat/count/', '/_cat/recovery?help', '/_cat/recovery?help', '/_cat/health?help', '/_cat/pending_tasks?help', '/_cat/aliases?help',
